...
function Certificates() {
  ...
  return (
    <section id="certificates" className="relative py-16 bg-gray-900 text-white">
      {/* Line on top of the section */}
      <div className="absolute top-0 left-0 w-full h-1 bg-yellow-400"></div>

      <div className="container mx-auto px-4 mt-4"> {/* Add margin top to avoid overlap */}
          ...
          {certificates.map((cert, index) => (
            ...
            >
              ...
              <div className="p-6">
                ...
                <p className="text-gray-500 text-sm mb-4">Issued on: {cert.issueDate}</p>
